...
interface SoapResponse {
  ...
  Fault?: SoapFault;
  'ns1:executeCommandResponse'?: { result?: string };
  executeCommandResponse?: { result?: string };
}
...
export class SoapClient {
   ...
   * @param command - server console command (e.g. ".server info")
   ...
   * @returns Promise with success status and message
   */
  async testConnection(): Promise<SoapResult> {
